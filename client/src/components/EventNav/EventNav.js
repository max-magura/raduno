          ...
          <Card.Body>
            <Card.Title>{this.props.eventName}</Card.Title>
              <ListGroup variant="flush">
                <ListGroup.Item>
                  <b>Date:</b> {this.props.eventDate}
                </ListGroup.Item>
                <ListGroup.Item>
                  <b>Time:</b> {this.props.eventTime}
                </ListGroup.Item>
                <ListGroup.Item>
                  <b>Address:</b><a href={`https://www.google.com/maps/place/${this.props.eventLocationStreet + " " + this.props.eventLocationCity + " " + this.props.eventLocationState + " " + this.props.eventLocationZipCode}`} >
                    {this.props.eventLocationStreet}, {this.props.eventLocationCity}, {this.props.eventLocationState}, {this.props.eventLocationZipCode}</a> 
                </ListGroup.Item>
                <ListGroup.Item>
                  <b>Description:</b> {this.props.eventDescription}
                </ListGroup.Item>
              </ListGroup>
          </Card.Body>
        </Card>
